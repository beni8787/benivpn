...
const zoneID = "6c13a38bcb0e88b9e5c01e0500310485"; // Ganti dengan Zone ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
...
const KV_PROXY_URL = "https://github.com/beni8787/vpn/blob/155365436c7693dc09c2ca77947579eb52690402/kvProxyList.json";
const PROXY_BANK_URL = "https://github.com/beni8787/vpn/blob/155365436c7693dc09c2ca77947579eb52690402/proxyList.txt";
...
function getAllConfig(request, hostName, proxyList, page = 0) {
  ...
  try {
    ...
    document.setTitle("Welcome to <span class='text-blue-500 font-semibold'>Beni-VPN</span>");
